...
const generateProjects = projectsArr => {
    ...
    //             </h5>
    //             <p>${description}</p>
    //             <a href="${link}" class="btn mt-auto"><i class="fab a-github mr-2"></i>View Project on GitHub</a>
    //         </div>
    //     `;
    // });
...
module.exports = templateData => {
    ...
    //destructure 'projects' and 'about' data from templateData (obj) based on their property key names
    ...
    <body>
        <header>
            <div class="container flex-row justify-space-betwen align-center py-3">
                <h1 clas="page-title text-secondary bg-dark py-2 px-3">${header.name}</h1>
                <nav class="flex-row">
